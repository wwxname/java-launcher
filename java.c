...
main(int argc, char ** argv)
{
    ...
    printf("Using java jvmpath at: %s\n", jvmpath);
    ...
    printf("Using java classpath at: %s\n", s);
#ifndef JAVA_ARGS
    SetClassPath(s);
#endif
...
//    jclass clsm = (*env)->FindClass(env,"Demo");
//    jmethodID midm = (*env)->GetStaticMethodID(env,clsm, "main","([Ljava/lang/String;)V");
//    (*env)->CallStaticVoidMethod(env,clsm, midm, NULL);
    NULL_CHECK0(mid = (*env)->GetMethodID(env, cls, "<init>",
                                          "(Ljava/lang/String;)V"));
